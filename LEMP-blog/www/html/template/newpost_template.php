...
<body>
    ...
    <div class = "blog-posts">
        ...
        <form method="post" action="/controller/updatedeletepost.php">
            <h4>Post Title : <textarea name = "blog_title" rows="1" cols="50" min="3" max="150"class = "blog-post-title" required></textarea></h4>
            <div class="blog-post-details">
                <h5> Author : <input type="text" name = "author" min="3" max="30" class = "author" required></input><br></h5>
