...
<body>
    <div class = "header-inner">    
        <div class = "blog-title">
            <h1> <a href="/index.php"> Заметки чата БПФ </a> </h1> 
        </div>
    ...
    <div class = "blog-posts">
        <h4 style="text-align:center"> Заметки и мысли </h4>
        ...
        <?php if ($result->num_rows > 0) {
           while($row = $result->fetch_assoc()) { ?>
            <li id="blog-post-list">
                ...
                <form method="post" action="/controller/updatedeletepost.php" style="display:inline-block">
                    <input type="submit" name = "action" value="Update"/>
                    <input type="hidden" name = "id" value=<?php echo $row['id']?>>
                </form>
                <form method="post" action="/controller/updatedeletepost.php" onsubmit="return confirm_submit();" style="display:inline-block">
